												...
												case"reply_show":
													...
													case "delete_Comment":
													{
														...
														if( toUserIdStr !=null && !"".equals(toUserIdStr))
														{
															...
															articleReply.setUserReplyToId( toUserId  )   ;
															//调用service层
															if( articleShowService.replyDeleteReply(articleReply))
															{
														...
														//用户选择了回复的按钮,并且进行了回复的内容的提交
															...
															//调用service层
															boolean success = articleShowService.replyDeleteReply(articleReply);
															boolean success2 = articleShowService.updateReply(articleId);
														...
														response.sendRedirect(request.getContextPath()+"/ArticleShowServlet?method=article_show&article_id="+articleIdStr);
														break;
													}
